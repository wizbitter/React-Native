...
export default class Camera extends Component<{}> {
	static navigationOptions = {
	  ...
	  constructor(props) {
	    ...
	    this.act = this.cameraAction.bind(this);
	  }
 ...
 cameraAction(){
  ...
  startRecording = async function() {
    ...
    if (this.camera) {
      ...
      this.setState({cameraState: 'photo'});
      ...
      >
        ...
        >
          ...
          style={{
            ...
            onPress={this.cameraAction.bind(this)}
          >
